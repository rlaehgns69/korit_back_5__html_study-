...
(function(w) {
    ...
    try {
        var links = ["https:\/\/mat.adpies.com\/mat\/init?oaid=a63ae8920369150ef3975501dfef3f9d\u0026landing=https%3A%2F%2Fastg.widerplanet.com%2Fdelivery%2Fwpp.php%3Fwpg%3Dadpies_rtb%26oaid%3Da63ae8920369150ef3975501dfef3f9d","https:\/\/cm.g.doubleclick.net\/pixel?google_nid=wider_planet\u0026google_cm\u0026google_ula=12153253,1707806967\u0026poaid=a63ae8920369150ef3975501dfef3f9d","https:\/\/cm-exchange.toast.com\/bi\/pixel?cm_pid=1107948209\u0026puid=a63ae8920369150ef3975501dfef3f9d\u0026toast_push"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function() {
var ttd = new Image();
ttd.src = "https:\/\/match.adsrvr.org\/track\/cmf\/generic?ttd_pid=ven6wdk\u0026ttd_tpi=1\u0026ttd_puid=a63ae8920369150ef3975501dfef3f9d";
})();
/*]]>*/
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-a63ae8920369150ef3975501dfef3f9d-s1707562584.259871|windows_10|chrome-15fda6h", 365);
                return;
            }
        }
